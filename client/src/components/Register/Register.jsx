            ...
            <div className="registerBox">
                ...
                <form action="" className="regForm" onSubmit={handleSubmit}>
                    <div className="regUsernameBox">
                        <label
                            htmlFor=""
                            className="registerLabel regUserLabel"
                        >
                            USERNAME
                        </label>
                        <input
                    ...
                    <div className="regEmailBox">
                        <label
                            htmlFor=""
                            className="registerLabel regEmailLabel"
                        >
                            E-MAIL
                        </label>
                        <input
                    ...
                    <div className="regPasswordBox">
                        <label
                            htmlFor=""
                            className="registerLabel regPassLabel"
                        >
                            PASSWORD
                        </label>
                        <input
                    ...
                    <div className="regPasswordConfirmBox">
                        <label
                            htmlFor=""
                            className="registerLabel regPassConfirmLabel"
                        >
                            PASSWORD CONFIRM
                        </label>
                        <input
                            type="password"
                            className="registerInput regPassConfirmInput"
                            required
                            value={username}
                    ...
                    <Link>
                        <button className="regBtn" type="submit" to="/register">
                            Register
                        </button>
                    </Link>
                </form>
                {error === true && (
                    <span className="errorNot">Something went wrong...</span>
                )}
            </div>
        </div>
    )
